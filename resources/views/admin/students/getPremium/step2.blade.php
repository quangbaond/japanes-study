<div class="container px-0">
    <div class="card card-outline card-warning d-none" id="step2">
        <div class="card-header float-right border-bottom-0">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 pt-0">
                    <form action="" method="post" id="formSubmitCreditOrDebit" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="icheck-primary">
                                    <input type="radio" id="radioPrimary2" name="choicePayment" value="1">
                        ...
                        <div class="card d-none" id="formCredit">
        ...
        <div class="card-footer">
            ...
            <buton type="button" class="btn btn-warning btn-flat float-right" id="btnSubmitCredit">{{ __('button.submit') }}</buton>
        </div>
    </div>
</div>
